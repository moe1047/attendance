    ...
    public function setup()
    {
        ...
        */
        ...
        $this->crud->addField([       // Select2Multiple = n-n relationship (with pivot table)
            'label' => "Except for (Employees name)",
            'type' => 'select2_multiple',
            'name' => 'exceptions', // the method that defines the relationship in your Model
            'entity' => 'exceptions', // the method that defines the relationship in your Model
